...
/**
 * TimetableModel class provides methods to manage timetable records.
 * It allows CRUD operations and custom checks for timetable constraints.
 * All database interactions are handled via JDBC.
 * 
 * @author ORS
 */
public class TimetableModel {
    ...
    /**
     * Returns the next primary key for Timetable table.
     * 
     ...
     * 
     * @param bean TimetableBean object containing data
     * @return primary key of the added record
     * @throws ApplicationException if there is a database error
     ...
     * @throws ApplicationException if there is a database error
     * @throws DuplicateRecordException if the updated record conflicts with another
     */
     ...
     * 
     * @param bean TimetableBean containing the record to delete
     * @throws ApplicationException if there is a database error
     */
    ...
    /**
     * Checks timetable by courseId and examDate.
     * 
     * @param courseId course ID
     * @param examDate exam date
     * @return TimetableBean object if found
     * @throws ApplicationException if there is a database error
     */
    ...
    /**
     * Checks timetable by courseId, subjectId and examDate.
     * 
     * @param courseId  course ID
    ...
    /**
     * Checks timetable by courseId, subjectId, semester, and examDate.
     * 
     * @param courseId  course ID
     * @param subjectId subject ID
    ...
    /**
     * Checks timetable by all attributes including exam time and description.
     * 
     * @param courseId    course ID
     * @param subjectId   subject ID
     * @param semester    semester
    ...
    /**
     * Searches timetable records based on provided criteria and pagination.
     * 
     * @param bean     TimetableBean containing search criteria
     * @param pageNo   page number for pagination
     * @param pageSize page size for pagination
     * @return list of TimetableBean objects matching the search criteria
     * @throws ApplicationException if there is a database error
     */
