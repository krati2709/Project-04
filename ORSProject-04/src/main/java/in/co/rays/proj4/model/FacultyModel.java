...
/**
 * Model class that handles CRUD operations for the Faculty entity.
 * Provides methods to add, update, delete, search, and retrieve Faculty records
 * from the database. It also handles linking with College, Course, and Subject entities.
 * 
 * @author krati
 */
public class FacultyModel {
    ...
    /**
     * Retrieves the next primary key for the Faculty table.
     * 
     ...
     * Populates College, Course, and Subject names based on IDs before insertion.
     * 
     ...
     * @throws DuplicateRecordException if a faculty with the same email already exists
     */
     ...
     * Updates College, Course, and Subject names based on IDs.
     * 
     * @param bean the FacultyBean containing updated faculty details
     * @throws ApplicationException if a database error occurs
     * @throws DuplicateRecordException if a faculty with the same email already exists
     */
     ...
     * 
     * @param bean the FacultyBean containing the faculty to delete
     * @throws ApplicationException if a database error occurs
     */
     ...
     * 
     * @param pk the primary key of the faculty
     * @return the FacultyBean if found, otherwise null
     * @throws ApplicationException if a database error occurs
     */
    ...
    /**
     * Searches for Faculty records with optional filters and pagination.
     * 
     * @param bean the FacultyBean containing search criteria (optional)
     * @param pageNo the page number for pagination (starting from 1)
     * @param pageSize the number of records per page
     * @return a list of FacultyBean objects matching the criteria
     * @throws ApplicationException if a database error occurs
     */
    public List<FacultyBean> search(FacultyBean bean, int pageNo, int pageSize) throws ApplicationException {
        ...
        if (bean != null) {
            ...
            if (bean.getDob() != null) sql.append(" and dob = " + bean.getDob());
