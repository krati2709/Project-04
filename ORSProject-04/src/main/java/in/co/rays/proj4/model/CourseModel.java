...
/**
 * CourseModel provides CRUD operations and search functionality for the Course entity.
 * It communicates with the database using JDBC.
 * 
 * @author krati
 */
public class CourseModel {
     ...
     * 
     * @param bean the CourseBean containing course data
     ...
     * 
     * @param bean the CourseBean containing updated data
     * @throws ApplicationException       if any database error occurs
     * @throws DuplicateRecordException   if a course with the same name exists for another record
     */
     ...
     * 
     * @param bean the CourseBean containing course ID to delete
     * @throws ApplicationException if any database error occurs
     */
    ...
    /**
     * Finds a course record by primary key (ID).
     * 
    ...
    /**
     * Finds a course record by course name.
     * 
    ...
    /**
     * Searches for courses based on filter criteria in CourseBean.
     * Supports pagination.
     * 
     * @param bean     filter criteria as CourseBean
